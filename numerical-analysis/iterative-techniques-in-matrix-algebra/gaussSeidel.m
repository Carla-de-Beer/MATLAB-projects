...
%GAUSSSEIDEL is the Gauss-Seidel iterative method to solve Ax = b, given an
%initial approximation x(0).
%   x = gaussSeidel(A, b, x0, TOL, N) computes the value of x using
%   Gauss-Seidel iterative method A is an nxm matrix, and b an nx1 vector. x0 is the start value and TOL the
%   tolerance measure.
